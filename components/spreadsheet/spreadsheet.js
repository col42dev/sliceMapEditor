...
var Spreadsheet = (function () {
    function Spreadsheet(el) {
        this.model = new spreadsheetModel_1.SpreadsheetModel(10, 4, 100, 100);
        this.element = el;
    }
    ...
    Spreadsheet.prototype.getVisibleCols = function (row) {
        var _this = this;
        return row.columns.filter(function (col) { return col.columnIndex >= _this.model.colStart && col.columnIndex < _this.model.colEnd; });
    };
    Spreadsheet.prototype.getVisibleColsHeaders = function () {
        var _this = this;
        return this.model.rows[this.model.end - 2].columns.filter(function (col) { return col.columnIndex >= _this.model.colStart && col.columnIndex < _this.model.colEnd; });
    };
